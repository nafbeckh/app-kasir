        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <label for="kasir" class="col-sm-2 col-form-label">Kasir :</label>
                    <div class="col-sm-10">
                        <select name="" id="kasir" class="form-control select2 select2bs4" style="width: 100%;">
...
<script>
    $(document).ready(function() {
        ...
        $('#tanggal').daterangepicker({
            ...
            let datakasir = $('#kasir').select2('data')
            let kasir = datakasir[0].id == '' ? "{{ $user->id }}" : datakasir[0].id
            $.get(`{{ route('laporan.kasir') }}?awal=${start}&akhir=${end}&kasir=${kasir}`).done(function(res) {
                if (res.status == true) {
                    // console.log(res)
                    table.clear().draw()
                    let totalpenj = 0
