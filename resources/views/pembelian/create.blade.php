            ...
            <div class="card-body">
                <form method="POST" action="" class="mb-2">
                    ...
                    <div class="input-group row mb-2">
                        ...
                        <select id="supplier" class="form-control col-sm-9 select2 select2bs4">
                            <option value="">Pilih Supplier</option>
                        </select>
                        <div class="input-group-append">
                            <button type="button" id="btnSupplier" class="btn btn-primary btn-flat" data-toggle="toooltip" title="Tambah Supplier">
                    ...
                    <div class="input-group row">
                        ...
                        <div class="input-group-append">
                            <button type="button" id="btnProduk" class="btn btn-primary btn-flat" data-toggle="toooltip" title="Pilih Produk">
                    ...
                    <div class="col-sm-5">
                        <form action="" class="form-pembelian" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <button type="button" id="simpantrx" class="btn btn-primary btn-lg btn-flat pull-right btn-block"><i class="fas fa-save mr-1"></i> Simpan Transaksi</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<div class="modal animated fade fadeInDown" id="modalSupplier" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="formSupplier" action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="container">
                        <div class="form-group row">
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('#formSupplier .error.invalid-feedback').each(function(i) {
                            $(this).hide();
                        });
                        $('#formSupplier input.is-invalid').each(function(i) {
        ...
        $("#inputProduk").select2({
            ...
            if (tbldttrx.length > 0) {
                ...
                if (ada == true) {
                    ...
                    tabletrx.row.add([data[0].id, data[0].kode, data[0].nama, data[0].harga, 0, 0, 0]).draw();
                }
            } else {
                tabletrx.row.add([data[0].id, data[0].kode, data[0].nama, data[0].harga, 0, 0, 0]).draw();
            }
        ...
        $('#produk tbody').on('click', "#btnPilih", function() {
            ...
            if (tbldttrx.length > 0) {
                ...
                if (ada == true) {
                    ...
                    tabletrx.row.add([tbldt.id, tbldt.kode_prod, tbldt.nama_prod, tbldt.harga_beli, 0, 0, 0]).draw();
                    Swal.fire(
                        tbldt.nama_prod,
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        supplier_id: $('#supplier').select2('data')[0].id,
                                        total_item: total,
