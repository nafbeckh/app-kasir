    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-cube mr-1" data-toggle="tooltip" title="{{ $title }}"></i>{{ $title }}</h3>
            ...
            <form id="form" action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama" class="col-sm-3 col-form-label"><i class="fas fa-cube mr-1" data-toggle="tooltip" title="Nama Kategori"></i>Nama Kategori :</label>
                        <div class="col-sm-9">
                            <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukkan Nama" minlength="2" required>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="formEdit" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="edit_nama" class="col-sm-3 col-form-label"><i class="fas fa-user mr-1" data-toggle="tooltip" title="Nama Kategori"></i>Nama Kategori :</label>
                        <div class="col-sm-9">
        ...
        $('#edit_reset').click(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#edit_nama').val(result.data.nama_kat);
                },
