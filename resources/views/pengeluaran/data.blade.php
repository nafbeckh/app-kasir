    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-money-bill mr-1" data-toggle="tooltip" title="{{ $title }}"></i>{{ $title }}</h3>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="form-group row">
                            <label for="deskripsi" class="col-sm-3 col-form-label"><i class="fas fa-clipboard mr-1" data-toggle="tooltip" title="Deskripsi"></i>Deskripsi :</label>
                            <div class="col-sm-9">
                                <input type="text" name="deskripsi" class="form-control" id="deskripsi" placeholder="Masukkan Deskripsi" minlength="2" maxlength="50" required>
                                <span id="err_deskripsi" class="error invalid-feedback" style="display: hide;"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nominal" class="col-sm-3 col-form-label"><i class="fas fa-money-bill mr-1" data-toggle="tooltip" title="Nominal"></i>Nominal :</label>
                            <div class="col-sm-9">
                                <input type="number" name="nominal" class="form-control" id="nominal" placeholder="Masukkan Nominal" value="0" required>
                                <span id="err_nominal" class="error invalid-feedback" style="display: hide;"></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="formEdit" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="form-group row">
                            <label for="edit_deskripsi" class="col-sm-3 col-form-label"><i class="fas fa-clipboard mr-1" data-toggle="tooltip" title="Deskripsi"></i>Deskripsi :</label>
                            <div class="col-sm-9">
                                <input type="text" name="deskripsi" class="form-control" id="edit_deskripsi" placeholder="Masukkan Deskripsi" minlength="2" maxlength="50" required>
                                <span id="err_edit_deskripsi" class="error invalid-feedback" style="display: hide;"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="edit_nominal" class="col-sm-3 col-form-label"><i class="fas fa-money-bill mr-1" data-toggle="tooltip" title="Nominal"></i>Nominal :</label>
                            <div class="col-sm-9">
                                <input type="number" name="nominal" class="form-control" id="edit_nominal" placeholder="Masukkan Nominal" required value="0">
                                <span id="err_edit_nominal" class="error invalid-feedback" style="display: hide;"></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#formEdit').submit(function(event) {
            ...
            submitHandler: function(form) {
                ...
                let url = "{{ route('pengeluaran.update', ':id') }}";
                url = url.replace(':id', id);
                $.ajax({
                    type: 'POST',
                    url: url,
        ...
        $('#formDeleteBatch').submit(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('pengeluaran.destroy.batch') }}",
                data: $(form).serialize(),
                beforeSend: function() {
                    console.log('otw')
                },
