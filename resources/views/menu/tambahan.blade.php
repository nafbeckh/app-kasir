...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{ $title }} Untuk {{$meja->nama}}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('menu.pesanan') }}">Pesanan Aktif</a></li>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Pesanan Tambahan {{$meja->nama}}</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" id="pesanMenu">Tambahkan</button>
            </div>
        </div>
    </div>
</div>
